...
namespace ETicaretAPI.API.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        [HttpPost("[action]")]
        public async Task<IActionResult> RefreshTokenLogin([FromBody]RefreshTokenLoginCommandRequest refreshTokenLogin)
        {
            RefreshTokenLoginCommandResponse response = await _mediator.Send(refreshTokenLogin);
            return Ok(response);
        }
